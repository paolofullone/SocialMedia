...
namespace Post.Cmd.Api.Controllers
{
    ...
    public class EditMessageController : ControllerBase
    {
        ...
        public async Task<ActionResult> EditMessageAsync(Guid id, EditMessageCommand command)
        {
            ...
            // We have this aggregateNotFoundException on editing a Post and we do not have it when we are creating
            // a Post because we want to retrieve the aggregate from the database when we edit a Post, and if it does not exist we throw.
