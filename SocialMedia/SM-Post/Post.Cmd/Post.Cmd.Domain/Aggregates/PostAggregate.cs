...
namespace Post.Cmd.Domain.Aggregates
{
    public class PostAggregate : AggregateRoot
    {
        ...
        private readonly Dictionary<Guid, Tuple<string, string>> _comments = new(); // recebe o comentário e o username
        ...
        public void Apply(PostCreatedEvent @event) // é chamado pelo RaiseEvent na classe AggregateRoot, então quando faz um post, esse método é chamado.
        {
            _id = @event.Id;
            _active = true;
        ...
        public void Apply(MessageUpdatedEvent @event) // esse apply é chamado pelo RaiseEvent do EditMessage. Vai alterar o estado do aggregate e setar o novo id.
        {
            _id = @event.Id;
        }
